...
import 'package:movie/widgets/casts.dart';
import 'package:movie/widgets/movie_info.dart';
import 'package:movie/widgets/similar_movies.dart';
...
class _MovieDetailScreenState extends State<MovieDetailScreen> {
            ...
            slivers: <Widget>[
              SliverAppBar(
                ...
                flexibleSpace: FlexibleSpaceBar(
                  title: Text(movie.title.length>40?movie.title.substring(0,37)+"...":movie.title,style: TextStyle(
                    fontSize: 12.0,
                    ...
                    children: <Widget>[
                      Container(
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(image: NetworkImage("https://image.tmdb.org/t/p/original/"+movie.backPoster))
                        ),
                        child: Container(
                          decoration: BoxDecoration(
  ...
  Widget _buildVideoWidget(VideoResponse data){
    ...
    return FloatingActionButton(
      onPressed: (){
        Navigator.push(context, MaterialPageRoute(builder: (context)=>VideoPlayer(controller: YoutubePlayerController(initialVideoId: videos[0].key,flags: YoutubePlayerFlags(
          autoPlay: true,
          forceHD: true
        )))));
      },
